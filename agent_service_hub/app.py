...
DESIGN_IMG = [
    r"https://lhcos-84055-1317429791.cos.ap-shanghai.myqcloud.com/Agent演示/uav微服务.png",
    r"https://lhcos-84055-1317429791.cos.ap-shanghai.myqcloud.com/Agent演示/workflow.png",
]

RESULT_IMG = [
    r"https://lhcos-84055-1317429791.cos.ap-shanghai.myqcloud.com/Agent演示/uav_result.png",
    r"https://lhcos-84055-1317429791.cos.ap-shanghai.myqcloud.com/Agent演示/microservices.png",
]
...
def run_demo_with_gradio(starting_agent, context_variables=None, debug=False):
    ...
    with gr.Blocks() as demo:
        ...
        # with gr.Row():
        #     with gr.Column(scale=1):
        #         gr.Textbox(label="示例输入(无人机demo)", value=DEMO_INPUT[0],lines=15)
        #     with gr.Column(scale=1):
        #         gr.Textbox(label="示例输入(学生demo)", value=DEMO_INPUT[1],lines=15)
        with gr.Tab('无人机demo'):
            gr.Textbox(label="示例输入(无人机demo)", value=DEMO_INPUT[0], lines=10)
            gr.Markdown("# 设计")
            gr.Image(DESIGN_IMG[0])
            gr.Markdown(RESULT_MERMAID[0])
            gr.Image(RESULT_IMG[0])
        with gr.Tab('学生demo'):
            gr.Textbox(label="示例输入(学生demo)", value=DEMO_INPUT[1], lines=10)
            gr.Markdown("# 设计")
            gr.Image(DESIGN_IMG[1])
            gr.Markdown(RESULT_MERMAID[1])
            gr.Image(RESULT_IMG[1])
